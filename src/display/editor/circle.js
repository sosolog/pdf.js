...
import { CircleDrawOutline, CircleDrawOutliner } from "./drawers/circledraw.js";
import { AnnotationEditor } from "./editor.js";
import { InkAnnotationElement } from "../annotation_layer.js";

class CircleDrawingOptions extends DrawingOptions {
  ...
  clone() {
    const clone = new CircleDrawingOptions(this._viewParameters);
...
class CircleEditor extends DrawingEditor {
  ...
  static initialize(l10n, uiManager) {
    ...
    this._defaultDrawingOptions = new CircleDrawingOptions(
  ...
  static deserializeDraw(
    ...
    return CircleDrawOutline.deserialize(
      pageX,
      pageY,
      pageWidth,
      pageHeight,
...
export { CircleDrawingOptions, CircleEditor };
