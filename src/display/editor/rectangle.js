...
import { RectangleDrawOutline, RectangleDrawOutliner } from "./drawers/rectangledraw.js";
import { AnnotationEditor } from "./editor.js";
import { InkAnnotationElement } from "../annotation_layer.js";

class RectangleDrawingOptions extends DrawingOptions {
  ...
  clone() {
    const clone = new RectangleDrawingOptions(this._viewParameters);
...
class RectangleEditor extends DrawingEditor {
  ...
  static initialize(l10n, uiManager) {
    ...
    this._defaultDrawingOptions = new RectangleDrawingOptions(
  ...
  static createDrawerInstance(x, y, parentWidth, parentHeight, rotation) {
    return new RectangleDrawOutliner(
      x,
      y,
      parentWidth,
      parentHeight,
  ...
  static deserializeDraw(
    ...
    return RectangleDrawOutline.deserialize(
      pageX,
      pageY,
      pageWidth,
      pageHeight,
...
export { RectangleDrawingOptions, RectangleEditor };
